...
const plans = [
  { name: 'Gratis', price: '$0', period: 'siempre', color: 'text-gray-700', border: 'border-gray-200', bg: 'bg-white', cta: 'Empezar Gratis', ctaStyle: 'bg-gray-100 hover:bg-gray-200 text-[#1F2937]', href: '/registrar-negocio' },
  { name: 'Emprendedor', price: '$60', period: 'MXN/mes', color: 'text-[#FF6B35]', border: 'border-[rgba(255,107,53,0.3)]', bg: 'bg-white', cta: 'Elegir Emprendedor', ctaStyle: 'bg-[rgba(255,107,53,0.1)] hover:bg-[rgba(255,107,53,0.2)] text-[#FF6B35]', href: '/registrar-negocio' },
  { name: 'Pro', price: '$120', period: 'MXN/mes', color: 'text-emerald-600', border: 'border-emerald-500/30', bg: 'bg-white', popular: true, cta: 'Elegir Pro', ctaStyle: 'bg-[#FF6B35] hover:bg-[#E2541F] text-white', href: '/registrar-negocio' },
