...
export const metadata: Metadata = {
  title: 'Para Negocios — Crece en SomosLagos',
  description: 'Te encontramos, te contactan, te administras. Planes para tu negocio en Lagos de Moreno: Gratis, Destacado y Vende en Linea. Sin contratos.',
  alternates: {
    canonical: 'https://www.somoslagos.com.mx/para-negocios',
  },
  openGraph: {
    title: 'Para Negocios — Crece en SomosLagos',
    description: 'Directorio, WhatsApp, estadisticas y ventas en linea para tu negocio en Lagos de Moreno.',
    url: 'https://www.somoslagos.com.mx/para-negocios',
  },
}
...
export default function PlanesPage() {
  return (
    <main className="min-h-screen pueblo-shell">
      ...
      {/* ── Hero B2B: Te encontramos / Te contactan / Te administras ── */}
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-5xl mx-auto rounded-3xl border border-white/10 overflow-hidden grid md:grid-cols-2 gap-0 bg-pueblo-noche">
            ...
            <div className="p-10 md:p-14 flex flex-col justify-center">
              ...
              <h1
                className="text-4xl md:text-5xl font-black text-pueblo-crema mb-6 leading-[0.95] tracking-tight"
