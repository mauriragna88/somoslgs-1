...
const UPGRADE_MESSAGES = {
  gratis: {
    ...
    subtitle: 'Sube al Plan Emprendedor',
    features: [
      'Portada personalizada para tu negocio',
      'Redes sociales visibles en tu perfil',
      'Galería con hasta 8 fotos',
      'Destaca frente a los planes gratis',
    ],
    price: '$60',
  ...
  avanzado: {
    ...
    subtitle: 'Sube al Plan Chatbot',
    features: [
      'Chatbot de pedidos con inteligencia artificial',
      'Tus clientes piden sin escribir textos largos',
      'Catálogo automático en el chat',
      'Atención 24/7 aunque estés ocupado',
    ],
    price: '$300',
    targetPlan: 'chatbot',
...
export default function UpgradeBanner({ currentPlan, businessName }: UpgradeBannerProps) {
  ...
  // No mostrar banner si ya es chatbot (maximo plan)
  if (!upgrade || currentPlan === 'chatbot') {
    return null
  }
