  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-xl shadow-sm p-6">
        <h3 className="font-bold text-gray-900 mb-6">📈 Ventas Últimos 30 Días</h3>
        <div className="h-80">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Payment Methods */}
        <div className="bg-white rounded-xl shadow-sm p-6">
          <h3 className="font-bold text-gray-900 mb-6">💳 Métodos de Pago</h3>
          <div className="h-64">
      ...
      <div className="bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl p-6 text-white">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h4 className="font-bold text-lg">Estadísticas Premium</h4>
            <p className="text-white/80">
              Estos reportes se actualizan en tiempo real. Usa esta información para tomar mejores decisiones de negocio.
            </p>
          </div>
        </div>
      </div>
