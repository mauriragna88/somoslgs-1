...
export default function PremiumSlider({ businesses }: PremiumSliderProps) {
  ...
  return (
    <>
      ...
      <div className="relative rounded-3xl overflow-hidden border-2 border-accent/40 shadow-2xl shadow-accent/10 bg-secondary" style={{ perspective: '1200px' }}>
        ...
        <div className="relative h-72 sm:h-80 md:h-96 overflow-hidden">
          ...
          <div className="absolute top-4 right-4 z-10 flex items-center gap-1.5 bg-black/40 backdrop-blur-sm rounded-full px-3 py-1">
            <span className="text-accent font-bold text-sm">{current + 1}</span>
        ...
        <div className="h-1 bg-white/10 overflow-hidden">
          <div
            key={current}
            className="h-full bg-gradient-to-r from-accent via-primary-light to-accent"
            style={{
        ...
        {total > 1 && (
          <>
            <button
              ...
              className="absolute top-1/2 left-3 -translate-y-1/2 w-10 h-10 bg-black/30 hover:bg-black/60 backdrop-blur-sm rounded-full flex items-center justify-center text-white transition-all hover:scale-110 active:scale-95 z-10"
              aria-label="Anterior"
            >
            ...
            <button
              ...
              className="absolute top-1/2 right-3 -translate-y-1/2 w-10 h-10 bg-black/30 hover:bg-black/60 backdrop-blur-sm rounded-full flex items-center justify-center text-white transition-all hover:scale-110 active:scale-95 z-10"
              ...
              {businesses.map((_, i) => (
                <button
                  ...
                  className={`h-2 rounded-full transition-all duration-300 ${
                    i === current ? 'bg-accent w-6' : 'bg-white/40 hover:bg-white/60 w-2.5'
                  }`}
